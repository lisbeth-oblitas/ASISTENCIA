...
sealed class Destinations(
    ...
    object AsistenciaUI: Destinations("asistenciaUI","Adm. Asistencias", Icons.Filled.DateRange)
    ...
    object AsistenciaForm: Destinations("AsistenciaForm?actId={actId}", "Form Asistencia", Icons.Filled.Add){
        fun passId(actId:String?):String{
            return "AsistenciaForm?actId=$actId"
        }
    }
    ...
    object AsistenciaUI: Destinations("materialesxUI","Adm. Materialesxes", Icons.Filled.DateRange)

    object AsistenciaForm: Destinations("AsistenciaForm?matId={matId}", "Form Asistencia", Icons.Filled.Add){
        fun passId(asisId:String?):String{
            return "asistenciaForm?matId=$asisId"
        }
    }
